...
public class second extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel7.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1120, 390, 200, 150));

        jComboBox2.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "COMPUTER SCIENCE", "INFORMATION SCIENCE", "ARTIFICIAL INTELLIGENCE AND MACHINE LEARNING", "DATA SCIENCE", "ELECTRONICS AND COMMUNICATION", "MECHANICAL" }));
        jComboBox2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true));
        jPanel7.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 82, 820, 70));
        ...
        jPanel7.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 80, 210, 70));
        ...
        first.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 1420, 650));

        jLabel3.setFont(new java.awt.Font("Segoe UI Black", 1, 48)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("                SECOND YEAR");
        first.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 0, 1090, 80));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Connection con =DBConnection.getConnection();//("jdbc:mysql://localhost:3306/placement", "root", "Gaurav@29");
                String query="select *from roadmap where year='second' and branch=?";
